...
//                   {/* <img src={`${REACT_PUBLIC_IMAGES}/public/`} className="w-fill rounded-md z-10" /> */}
//                   <img src={`http://localhost:5000/public/course-images/${course.coverImage}`} className="w-fill rounded-md z-10" alt="Course Image" />
